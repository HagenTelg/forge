...
_LOGGER.info(f"Starting edit directive conversion for {STATION.upper()} in {format_iso8601_time(DATA_START_TIME)} to {format_iso8601_time(DATA_END_TIME)}")
...
for identity, info, modified in cpd3_edits:
    converted = EditDirective(identity, info, modified, allocated_uids=allocated_uids)
