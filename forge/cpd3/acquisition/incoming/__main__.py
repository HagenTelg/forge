...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Forge CPD3 acquisition incoming web server.")
...
def main():
    ...
    if args.bind_unix is not None:
        try:
            ...
            pass
        uvicorn.run('forge.cpd3.acquisition.incoming.server:app', workers=args.workers, access_log=args.debug,
