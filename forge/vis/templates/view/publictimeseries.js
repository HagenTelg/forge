...
replotController.layout.showlegend = false;
replotController.layout.hovermode = 'x unified';
replotController.layout.xaxis.showspikes  = true;
...
TimeSeriesCommon.overrideAveraging('{{ view.average.value }}')
