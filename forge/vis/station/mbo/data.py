...
if use_cpd3("mbo"):
    ...
    from ..default.data import aerosol_data, aerosol_public, ozone_data, ozone_public, data_get, DataStream, DataRecord, RealtimeRecord, Selection, RealtimeSelection, STANDARD_THREE_WAVELENGTHS, STANDARD_CUT_SIZE_SPLIT
