import typing
from ..default.mode import Mode, ViewList, detach, aerosol_modes, aerosol_public, radiation_modes


station_modes = detach(aerosol_modes, aerosol_public, radiation_modes)
