...
class PSAPStatus(TimeSeries):
    def __init__(self, mode: str, **kwargs):
        ...
        IrG.legend = "Calculated"
        IrG.data_record = f'{mode}-psapstatus'
        IrG.data_field = 'IrG'
        flow_transmittance.traces.append(IrG)

        IrcG = TimeSeries.Trace(transmittance)
        IrcG.legend = "Instrument"
        IrcG.data_record = f'{mode}-psapstatus'
        IrcG.data_field = 'IrcG'
        flow_transmittance.traces.append(IrcG)
