...
station_profile_data['aerosol']['raw']['scattering2-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
...
station_profile_data['aerosol']['raw']['scattering2-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
...
station_profile_data['aerosol']['editing']['scattering2-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: EditedReader(
...
station_profile_data['aerosol']['editing']['scattering2-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: EditedReader(
    start_epoch_ms, end_epoch_ms, station, 'aerosol', {
...
station_profile_data['aerosol']['clean']['scattering2-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'clean', 'BsB_S12', {'pm10'}): 'BsB',
        Name(station, 'clean', 'BsG_S12', {'pm10'}): 'BsG',
        Name(station, 'clean', 'BsR_S12', {'pm10'}): 'BsR',
...
station_profile_data['aerosol']['clean']['scattering2-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'clean', 'BsB_S12', {'pm1'}): 'BsB',
        Name(station, 'clean', 'BsG_S12', {'pm1'}): 'BsG',
        Name(station, 'clean', 'BsR_S12', {'pm1'}): 'BsR',
...
station_profile_data['aerosol']['avgh']['scattering2-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
...
station_profile_data['aerosol']['avgh']['scattering2-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
...
station_profile_data['aerosol']['raw']['pressure'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        ...
        Name(station, 'raw', 'P_S12', {'pm10'}): 'neph2-coarse',
        Name(station, 'raw', 'P_S12'): 'neph2-coarse',
        Name(station, 'raw', 'P_S12', {'pm1'}): 'neph2-fine',
        Name(station, 'raw', 'P_S12', {'pm25'}): 'neph2-fine',
...
station_profile_data['aerosol']['raw']['humidograph-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'raw', 'BsG_S11', {'pm10'}): 'dry',
        Name(station, 'raw', 'BsG_S11'): 'dry',
        Name(station, 'raw', 'BsG_S12', {'pm10'}): 'wet',
        Name(station, 'raw', 'BsG_S12'): 'wet',
    }, send
)
station_profile_data['aerosol']['raw']['humidograph-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'raw', 'BsG_S11', {'pm1'}): 'dry',
        Name(station, 'raw', 'BsG_S11', {'pm25'}): 'dry',
        Name(station, 'raw', 'BsG_S12', {'pm1'}): 'wet',
        Name(station, 'raw', 'BsG_S12', {'pm25'}): 'wet',
    }, send
)
station_profile_data['aerosol']['clean']['humidograph-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'clean', 'BsG_S11', {'pm10'}): 'dry',
        Name(station, 'clean', 'BsG_S11'): 'dry',
        Name(station, 'clean', 'BsG_S12', {'pm10'}): 'wet',
        Name(station, 'clean', 'BsG_S12'): 'wet',
    }, send
)
station_profile_data['aerosol']['clean']['humidograph-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'clean', 'BsG_S11', {'pm1'}): 'dry',
        Name(station, 'clean', 'BsG_S11', {'pm25'}): 'dry',
        Name(station, 'clean', 'BsG_S12', {'pm1'}): 'wet',
        Name(station, 'clean', 'BsG_S12', {'pm25'}): 'wet',
    }, send
)
station_profile_data['aerosol']['avgh']['humidograph-coarse'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'avgh', 'BsG_S11', {'pm10'}): 'dry',
        Name(station, 'avgh', 'BsG_S11'): 'dry',
        Name(station, 'avgh', 'BsG_S12', {'pm10'}): 'wet',
        Name(station, 'avgh', 'BsG_S12'): 'wet',
    }, send
)
station_profile_data['aerosol']['avgh']['humidograph-fine'] = lambda station, start_epoch_ms, end_epoch_ms, send: DataReader(
    start_epoch_ms, end_epoch_ms, {
        Name(station, 'avgh', 'BsG_S11', {'pm1'}): 'dry',
        Name(station, 'avgh', 'BsG_S11', {'pm25'}): 'dry',
        Name(station, 'avgh', 'BsG_S12', {'pm1'}): 'wet',
        Name(station, 'avgh', 'BsG_S12', {'pm25'}): 'wet',
    }, send
)
