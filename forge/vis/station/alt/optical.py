...
class OpticalCLAPSecondary(TimeSeries):
    ...
    def __init__(self, mode: str, **kwargs):
        ...
        self.title = "Second CLAP Optical Properties"
...
class OpticalPSAP(TimeSeries):
    ...
    def __init__(self, mode: str, **kwargs):
        ...
        absorption = self.ThreeWavelength(f'{mode}-psap', 'Ba')
        absorption.title = "Light Absorption"
        absorption.contamination = f'{mode}-contamination'
        self.graphs.append(absorption)
...
class EditingCLAPSecondary(TimeSeries):
    ...
    def __init__(self, profile: str = 'aerosol', **kwargs):
        super().__init__(**kwargs)
        self.title = "Second CLAP Light Absorption"
...
class EditingPSAP(TimeSeries):
    ...
    def __init__(self, profile: str = 'aerosol', **kwargs):
        ...
        edited = self.ThreeWavelength(f'{profile}-editing-psap', 'Ba', 'Edited {code} ({size})')
        edited.title = "Edited"
        edited.contamination = f'{profile}-editing-contamination'
        self.graphs.append(edited)
