...
if use_cpd3("spo"):
    ...
    from ..default.data import aerosol_data, aerosol_public, ozone_data, ozone_public, met_data, radiation_data, \
        data_get, DataStream, DataRecord, RealtimeRecord, Selection, RealtimeSelection, STANDARD_THREE_WAVELENGTHS
    ...
    for archive in ("raw", "editing", "clean", "avgh"):
        data_records[f"aerosol-{archive}-cnc"] = DataRecord({
            ...
            "cnc2": [Selection(variable_name="number_concentration",
                               instrument_id="N42")],
            "cnc3": [Selection(variable_name="number_concentration",
                               instrument_id="N44")],
        })
    data_records["aerosol-realtime-cnc"] = RealtimeRecord({
        ...
        "cnc2": [RealtimeSelection("N", variable_name="number_concentration",
                                   instrument_id="N42")],
        "cnc3": [RealtimeSelection("N", variable_name="number_concentration",
                                   instrument_id="N44")],
    })

    for (n, inst) in (("2", "N42"), ("3", "N44")):
        data_records[f"aerosol-raw-cpcstatus{n}"] = DataRecord({
            "Tinlet": [Selection(variable_name="inlet_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                       Selection(variable_name="inlet_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "TDinlet": [Selection(variable_name="inlet_dewpoint", instrument_code="admagic200cpc", instrument_id=inst),
                        Selection(variable_name="inlet_dewpoint", instrument_code="admagic250cpc", instrument_id=inst)],
            "Uinlet": [Selection(variable_name="inlet_humidity", instrument_code="admagic200cpc", instrument_id=inst),
                       Selection(variable_name="inlet_humidity", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tconditioner": [Selection(variable_name="conditioner_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                             Selection(variable_name="conditioner_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tinitiator": [Selection(variable_name="initiator_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                           Selection(variable_name="initiator_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tmoderator": [Selection(variable_name="moderator_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                           Selection(variable_name="moderator_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Toptics": [Selection(variable_name="optics_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                        Selection(variable_name="optics_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Theatsink": [Selection(variable_name="heatsink_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                          Selection(variable_name="heatsink_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tcase": [Selection(variable_name="case_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tboard": [Selection(variable_name="pcb_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                       Selection(variable_name="board_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "TDgrowth": [Selection(variable_name="growth_tube_dewpoint", instrument_code="admagic250cpc", instrument_id=inst)],
            "Qsample": [Selection(variable_name="sample_flow", instrument_code="admagic200cpc", instrument_id=inst),
                        Selection(variable_name="sample_flow", instrument_code="admagic250cpc", instrument_id=inst)],
            "Psample": [Selection(variable_name="pressure", instrument_code="admagic200cpc", instrument_id=inst),
                        Selection(variable_name="pressure", instrument_code="admagic250cpc", instrument_id=inst)],
            "PCTwick": [Selection(variable_name="wick_saturation", instrument_code="admagic250cpc", instrument_id=inst)],
            "Vpulse": [Selection(variable_name="pulse_height", instrument_code="admagic250cpc", instrument_id=inst)],
        })
        data_records[f"aerosol-realtime-cpcstatus{n}"] = RealtimeRecord({
            "Tinlet": [RealtimeSelection("Tinlet", variable_name="inlet_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                       RealtimeSelection("Tinlet", variable_name="inlet_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "TDinlet": [RealtimeSelection("TDinlet", variable_name="inlet_dewpoint", instrument_code="admagic200cpc", instrument_id=inst),
                        RealtimeSelection("TDinlet", variable_name="inlet_dewpoint", instrument_code="admagic250cpc", instrument_id=inst)],
            "Uinlet": [RealtimeSelection("Uinlet", variable_name="inlet_humidity", instrument_code="admagic200cpc", instrument_id=inst),
                       RealtimeSelection("Uinlet", variable_name="inlet_humidity", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tconditioner": [RealtimeSelection("Tconditioner", variable_name="conditioner_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                             RealtimeSelection("Tconditioner", variable_name="conditioner_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tinitiator": [RealtimeSelection("Tinitiator", variable_name="initiator_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                           RealtimeSelection("Tinitiator", variable_name="initiator_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tmoderator": [RealtimeSelection("Tmoderator", variable_name="moderator_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                           RealtimeSelection("Tmoderator", variable_name="moderator_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Toptics": [RealtimeSelection("Toptics", variable_name="optics_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                        RealtimeSelection("Toptics", variable_name="optics_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Theatsink": [RealtimeSelection("Theatsink", variable_name="heatsink_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                          RealtimeSelection("Theatsink", variable_name="heatsink_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tcase": [RealtimeSelection("Tcase", variable_name="case_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "Tboard": [RealtimeSelection("Tpcb", variable_name="pcb_temperature", instrument_code="admagic200cpc", instrument_id=inst),
                       RealtimeSelection("Tboard", variable_name="board_temperature", instrument_code="admagic250cpc", instrument_id=inst)],
            "TDgrowth": [RealtimeSelection("TDgrowth", variable_name="growth_tube_dewpoint", instrument_code="admagic250cpc", instrument_id=inst)],
            "Qsample": [RealtimeSelection("Q", variable_name="sample_flow", instrument_code="admagic200cpc", instrument_id=inst),
                        RealtimeSelection("Q", variable_name="sample_flow", instrument_code="admagic250cpc", instrument_id=inst)],
            "Psample": [RealtimeSelection("P", variable_name="pressure", instrument_code="admagic200cpc", instrument_id=inst),
                        RealtimeSelection("P", variable_name="pressure", instrument_code="admagic250cpc", instrument_id=inst)],
            "PCTwick": [RealtimeSelection("PCTwick", variable_name="wick_saturation", instrument_code="admagic250cpc", instrument_id=inst)],
            "Vpulse": [RealtimeSelection("Vpulse", variable_name="pulse_height", instrument_code="admagic250cpc", instrument_id=inst)],
        })
