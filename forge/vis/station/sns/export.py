...
if use_cpd3("app"):
    ...
    for archive in ("raw", "clean", "avgh"):
        export_entries["aerosol"][archive].append(ExportCSV("maap", "MAAP", [
            ExportCSV.Column([Selection(variable_id="X", instrument_code="thermomaap", instrument_id="A21",
                                        wavelength_number=0)]),
            ExportCSV.Column([Selection(variable_id="P", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="Q", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="Ld", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="T1", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="T2", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="T3", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="Pd1", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="Pd2", instrument_code="thermomaap", instrument_id="A21")]),
            ExportCSV.Column([Selection(variable_id="Ir", instrument_code="thermomaap", instrument_id="A21",
                                        wavelength_number=0)]),
            ExportCSV.Column([Selection(variable_id="If", instrument_code="thermomaap", instrument_id="A21",
                                        wavelength_number=0)]),
            ExportCSV.Column([Selection(variable_id="Ip", instrument_code="thermomaap", instrument_id="A21",
                                        wavelength_number=0)]),
            ExportCSV.Column([Selection(variable_id="Is1", instrument_code="thermomaap", instrument_id="A21",
                                        wavelength_number=0)]),
            ExportCSV.Column([Selection(variable_id="Is2", instrument_code="thermomaap", instrument_id="A21",
                                        wavelength_number=0)]),
        ]))
    ...
    for archive in ("raw", "clean", "avgh"):
        export_entries["aerosol"][archive].append(ExportCSV("ccn", "CCN", [
            ExportCSV.Column([Selection(variable_name="number_concentration", instrument_code="dmtccn"),
                              Selection(variable_name="number_concentration", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="Tu", instrument_code="dmtccn"),
                              Selection(variable_id="Tu", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="T1", instrument_code="dmtccn"),
                              Selection(variable_id="T1", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="T2", instrument_code="dmtccn"),
                              Selection(variable_id="T2", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="T3", instrument_code="dmtccn"),
                              Selection(variable_id="T3", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="T4", instrument_code="dmtccn"),
                              Selection(variable_id="T4", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="T5", instrument_code="dmtccn"),
                              Selection(variable_id="T5", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="T6", instrument_code="dmtccn"),
                              Selection(variable_id="T6", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="Q1", instrument_code="dmtccn"),
                              Selection(variable_id="Q1", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="Q2", instrument_code="dmtccn"),
                              Selection(variable_id="Q2", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="U", instrument_code="dmtccn"),
                              Selection(variable_id="U", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="P", instrument_code="dmtccn"),
                              Selection(variable_id="P", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
            ExportCSV.Column([Selection(variable_id="DT", instrument_code="dmtccn"),
                              Selection(variable_id="DT", instrument_code="dmtccn200", exclude_tags={"secondary"})]),
        ]))
