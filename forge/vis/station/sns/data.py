...
if use_cpd3("sns"):
    ...
    for archive in ("raw", "editing", "clean", "avgh"):
        data_records[f"aerosol-{archive}-maap"] = DataRecord({
            "Ba": [Selection(variable_name="light_absorption", wavelength_number=0,
                             instrument_code="thermomaap", instrument_id="A21")],
    ...
    data_records["aerosol-raw-maapstatus"] = DataRecord({
        "Psample": [Selection(variable_name="sample_pressure", instrument_code="thermomaap", instrument_id="A21")],
        "Tambient": [Selection(variable_name="sample_temperature", instrument_code="thermomaap", instrument_id="A21")],
        "Tmeasurementhead": [Selection(variable_name="measurement_head_temperature", instrument_code="thermomaap", instrument_id="A21")],
        "Tsystem": [Selection(variable_name="system_temperature", instrument_code="thermomaap", instrument_id="A21")],
        "Qsample": [Selection(variable_name="sample_flow", instrument_code="thermomaap", instrument_id="A21")],
        "Ir": [Selection(variable_name="transmittance", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "If": [Selection(variable_name="reference_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "Ip": [Selection(variable_name="sample_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "Is1": [Selection(variable_name="backscatter_135_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "Is2": [Selection(variable_name="backscatter_165_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
    })
    data_records["aerosol-realtime-maapstatus"] = RealtimeRecord({
        "Psample": [RealtimeSelection("P", variable_name="sample_pressure", instrument_code="thermomaap", instrument_id="A21")],
        "Tambient": [RealtimeSelection("Tsample", variable_name="sample_temperature", instrument_code="thermomaap", instrument_id="A21")],
        "Tmeasurementhead": [RealtimeSelection("Thead", variable_name="measurement_head_temperature", instrument_code="thermomaap", instrument_id="A21")],
        "Tsystem": [RealtimeSelection("Tsystem", variable_name="system_temperature", instrument_code="thermomaap", instrument_id="A21")],
        "Qsample": [RealtimeSelection("Q", variable_name="sample_flow", instrument_code="thermomaap", instrument_id="A21")],
        "Ir": [RealtimeSelection("Ir", variable_name="transmittance", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "If": [RealtimeSelection("If", variable_name="reference_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "Ip": [RealtimeSelection("Ip", variable_name="sample_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "Is1": [RealtimeSelection("Is135", variable_name="backscatter_135_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
        "Is2": [RealtimeSelection("Is165", variable_name="backscatter_165_intensity", instrument_code="thermomaap", wavelength_number=0, instrument_id="A21")],
    })
