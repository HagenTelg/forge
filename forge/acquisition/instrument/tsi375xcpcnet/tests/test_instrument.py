...
from forge.acquisition.instrument.tsi375xcpcnet.simulator import Simulator
from forge.acquisition.instrument.tsi375xcpcnet.instrument import Instrument
...
async def test_communications():
    ...
    assert await bus.value('PDinlet') == simulator.data_PDinlet
    ...
    assert await bus.value('Twatertrap') == simulator.data_Twatertrap
