...
from forge.acquisition.instrument.tsi377xcpc.simulator import Simulator
from forge.acquisition.instrument.tsi377xcpc.instrument import Instrument
...
@pytest.mark.asyncio
async def test_no_scd():
    simulator: Simulator = None
    instrument: Instrument = None
    simulator, instrument = await create_streaming_instrument(Instrument, Simulator)
    simulator.support_scd = False
    bus: BusInterface = instrument.context.bus
