...
from forge.processing.transfer.incoming.server import app


def parse_arguments():
    parser = argparse.ArgumentParser(description="Forge incoming data handling server.")
...
def main():
    ...
    if args.bind_unix is not None:
        try:
            ...
            pass
        uvicorn.run('forge.processing.transfer.incoming.server:app', workers=args.workers, access_log=args.debug,
