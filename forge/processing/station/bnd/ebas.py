...
def file(gaw_station: str, type_code: str, start_epoch_ms: int, end_epoch_ms: int) -> typing.Type["EBASFile"]:
    ...
    if end_epoch_ms <= 1140566400000 and type_code.startswith("absorption_"):
        type_code = "psap1w_" + type_code[11:]
    elif end_epoch_ms <= 1332633600000 and type_code.startswith("absorption_"):
        type_code = "psap3w_" + type_code[11:]

    if type_code == "psap1w_lev0" and end_epoch_ms <= 1332633600000:
        type_code = "psap1wlegacy_lev0"
    elif type_code == "psap3w_lev0" and end_epoch_ms <= 1332633600000:
